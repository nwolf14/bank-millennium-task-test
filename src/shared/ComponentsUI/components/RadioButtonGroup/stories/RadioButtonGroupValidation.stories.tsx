...
// others
import { radioButtonGroupValidation } from '../../../../../stories/constants';
...
export default {
  ...
  title: radioButtonGroupValidation,
...
export const RadioButtonGroupValidation = Template.bind({});

RadioButtonGroupValidation.argTypes = {
  errorMessage: {
    table: {
      disable: true,
    },
...
RadioButtonGroupValidation.args = {};
